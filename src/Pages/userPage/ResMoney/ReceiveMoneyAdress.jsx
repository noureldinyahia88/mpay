...
import { ReceiveFun } from "../../../Http/receiveMoney";
...
const ReceiveMoneyAdress = () => {
  ...
  async function handleSend(formData) {
    mutate({
      smartEmail: formData.PaymentAddress,
    ...
    <SendMoneyWrapper>
      ...
      <Container>
        <Wrapper>
          <TabsContainer>
            <TabListSidebar>
              <TabTitle to="/sendMoney/MobileNumber">Mobile Number</TabTitle>
              <TabTitle to="/sendMoney/Card">Card</TabTitle>
              <TabTitle to="/sendMoney/PaymentAddress">
                Payment Address
              </TabTitle>
            </TabListSidebar>
...
const Btn = styled.button`
  ...
  cursor: pointer;
`;
export default ReceiveMoneyAdress;
